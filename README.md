# nvim-treesitter-queries-nqc

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-nqc/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-nqc/actions/workflows/validate.yml)

Neovim tree-sitter queries for **nqc**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-nqc",
...
- [ ] Changes are scoped to `nqc` — do not include files for other languages
